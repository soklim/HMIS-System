...
class EMRDeath extends Model
{
    ...
    protected $fillable = [
        'death_id','issue_no','hfac_code','hfac_label', 'death_province_code', 'death_district_code', 'death_commune_code',
        'hmis_code','deceased_name','death_info','death_type','deceased_province_code','deceased_district_code','deceased_commune_code',
        'deceased_village','deceased_street','deceased_house','date_of_birth','age','sex','medical_file_id','medical_file_id','date_of_death',
