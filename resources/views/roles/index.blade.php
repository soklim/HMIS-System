            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    for (var i = 0; i < item.length; i++) {
                        var btnEdit ='<span class="text-primary" style="cursor: pointer;font-size: 24px" title="Edit" onclick="actionEdit('+item[i].id+',\''+item[i].name+'\')"><i class="bx bx-edit"></i> </span>';
