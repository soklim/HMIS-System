...
@section('content')
        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Setting Type</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Setting Type</h5>
                </div>
    ...
    <script type="text/javascript">
        ...
        function LoadData(){
            ...
            $.ajax({
                type:'GET',
                url:"{{ route('setting_types.GetData') }}",
                data:{},
